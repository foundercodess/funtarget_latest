...
class CustomContainer extends StatelessWidget {
  ...
  CustomContainer({this.alignment, this.padding, this.color, this.decoration, this.widths, this.height, this.margin, this.gradientColorOne, this.gradientColorTwo, this.shadowColor, this.dx, this.dy, this.gradient, this.Label, this.style, this.icon, this.fontWeight, this.fontStyle, this.iconColor, this.textColor, this.fontSize, this.begin, this.end,  this.blurRadius,  this.spreadRadius,  this.child, this.borderRadius,  this.blurStyle, this.boxShadow, this.onTap, this.border, this.image,  this.clipBehavior,}) ;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child:child ?? Row(
          children: [
            Text(Label==null?"":Label!, style: TextStyle(color: textColor,fontSize: fontSize),),
