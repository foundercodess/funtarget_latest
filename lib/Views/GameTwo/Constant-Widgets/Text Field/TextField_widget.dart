...
class GameTwoCustomTextField extends StatelessWidget {
  ...
  GameTwoCustomTextField({super.key, this.controller,
    this.style,
    this.strutStyle,
    ...
    this.onSaved,
    this.validator,
    this.margin, this.hintColor, this.errorText, this.borderSide, this.textcolor,
  });
          ...
          decoration: InputDecoration(
            ...
            hintStyle: GoogleFonts.alike(
              textStyle: TextStyle(
                  ...
                  fontWeight:FontWeight.normal,
                  fontStyle: FontStyle.normal,
                  color:hintColor==null? ColorConstant.greyColor:hintColor
              ),
            ),
            ...
            border: OutlineInputBorder(
              borderSide:borderSide==null? BorderSide(width:1, color: ColorConstant.whiteColor.withOpacity(0.5)):borderSide!,
                  borderRadius:fieldRadius== null? BorderRadius.all(Radius.circular(4.0)):fieldRadius!
            ),
